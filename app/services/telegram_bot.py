...
APPLE_HEALTH_HELP_TEXT = (
    ...
    "\n"
    "Рекомендований шлях — готовий Shortcut для Apple Shortcuts на iPhone. "
    "Це вбудований додаток Apple, нічого додатково встановлювати не треба.\n"
    "\n"
    "1. У Telegram натисни /connect_apple_health.\n"
    "2. Відкрий готовий Shortcut `Health Tracker Apple Health Sync` на iPhone.\n"
...
async def handle_connect_apple_health(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        "❤️ Apple Health\n"
        "\n"
        "Apple Health не має backend API, тому iPhone має сам надсилати дані. "
        ...
        f"{shortcut_url}\n"
        "\n"
        "Після імпорту запусти Shortcut один раз на iPhone і дозволь доступ до "
