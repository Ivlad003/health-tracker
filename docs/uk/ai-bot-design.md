...
Вільний, двомовний (UK/EN) Telegram-бот на базі OpenAI GPT, який працює як персональний асистент здоров'я. Користувачі спілкуються природною мовою, GPT розуміє наміри, а FastAPI оркеструє дії за лаштунками.
