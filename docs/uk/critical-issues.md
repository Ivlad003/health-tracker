...
### 4. n8n — Не для Production API

**Проблема:** n8n не призначений для high-load API.

**Рішення:** 
- Додати Fastify/Hono API layer між Web App і n8n
- n8n тільки для background jobs

---

### 5. Calorie Balance — Неповний розрахунок
...
### 6. Telegram Mini App — WebView обмеження
...
| 6 | Fastify API layer | 2-3 дні | 🟠 P1 |
| 7 | Локальна база UA продуктів | 3-5 днів | 🟡 P2 |
